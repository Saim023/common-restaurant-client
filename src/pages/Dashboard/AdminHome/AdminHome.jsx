...
const COLORS = ["#0088FE", "#0ef03b", "#FFBB28", "#FF8042", "#af3ade"];
      ...
      <div className="stats shadow">
        <div className="stat">
          <div className="stat-figure text-secondary">
            <GiMoneyStack className="text-3xl"></GiMoneyStack>
          </div>
        ...
        <div className="stat">
          ...
          <div className="stat-value">{stats?.userStats}</div>
        ...
        <div className="stat">
          ...
          <div className="stat-value">{stats?.menuStats}</div>
        ...
        <div className="stat">
          ...
          <div className="stat-value">{stats?.orderStats}</div>
          <div className="stat-desc">↘︎ 90 (14%)</div>
        </div>
      </div>
